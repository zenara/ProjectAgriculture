<%-- 
    ...
    Created on : Aug 8, 2016, 9:59:39 AM
      ...
      <div ng-controller="autoCompleteController as ctrl" layout="column" ng-cloak>
         <md-content class="md-padding">
            <form ng-submit="$event.preventDefault()">
               ...
               <p><code>md-autocomplete</code> caches results when performing a query.  After first call, 
                   it uses the cached results to eliminate unnecessary server requests or lookup logic and it can be disabled.</p>
            </form>
         </md-content>
      </div>
   </body>
